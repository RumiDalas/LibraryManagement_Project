...
public class ViewLibrarian extends javax.swing.JFrame {
    ...
    public void jTable1(){
        try{
            String sql =" select id,name,password,email,address,city,contact from addlibrarian " ;
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Address", "Password", "Email", "City", "Contact"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jLabel1.setText("All Librarian Information");
